...
define i32 @MT4.Start(i8* %this, i32 %.p1, i32 %.p2, i32 %.p3, i32 %.p4, i32 %.p5, i32 %.p6) {
    %p1 = alloca i32
    store i32 %.p1, i32* %p1 ; add the parameter to the stack

    %p2 = alloca i32
    store i32 %.p2, i32* %p2 ; add the parameter to the stack

    %p3 = alloca i32
    store i32 %.p3, i32* %p3 ; add the parameter to the stack

    %p4 = alloca i32
    store i32 %.p4, i32* %p4 ; add the parameter to the stack

    %p5 = alloca i32
    store i32 %.p5, i32* %p5 ; add the parameter to the stack

    %p6 = alloca i32
    store i32 %.p6, i32* %p6 ; add the parameter to the stack

    %aux = alloca i32
    %_0 = load i32, i32* %p1
    call void @print_int(i32 %_0) 
    %_1 = load i32, i32* %p2
    call void @print_int(i32 %_1) 
    %_2 = load i32, i32* %p3
    call void @print_int(i32 %_2) 
    %_3 = load i32, i32* %p4
    call void @print_int(i32 %_3) 
    %_4 = load i32, i32* %p5
